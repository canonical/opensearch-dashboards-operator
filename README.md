...
![OpenSearch Dashboards](./docs/resources/opensearch_dashboard.png)
...
You must create an "index pattern" that enables the Dashboards app to access the user's data.
